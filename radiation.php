...
<div id="portal_app_info" style="float: right; margin-right: 10px;"></div>Radiation Hazards</h2>
...
<?php $selected_sups = echo_supervisor_menu($conn, "rad_header", $role, $dept, $user_netid); ?>
